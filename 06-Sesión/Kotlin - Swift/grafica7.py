...
# Ruta del archivo
file_path = "D:/Documents/complementario-3125033/06-Sesión/Kotlin - Swift/kotlinSwift.xlsx"
...
kotlin = pd.to_numeric(data['Kotlin'], errors='coerce')  # Aseguramos conversión numérica
swift = pd.to_numeric(data['Swift'], errors='coerce')

# Graficar los datos
plt.figure(figsize=(10, 6))
plt.plot(semanas, kotlin, label='Kotlin', color='purple', marker='o')
plt.plot(semanas, swift, label='Swift', color='orange', marker='o')
...
plt.title('Comparativa de Popularidad: Kotlin vs Swift')
plt.legend()
plt.grid()
