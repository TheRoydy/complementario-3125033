...
# Ruta del archivo
file_path = "D:/Documents/complementario-3125033/06-Sesión/MySQL - SQL Server/baseDeDatos.xlsx"
...
mysql = pd.to_numeric(data['MySQL'], errors='coerce')  # Aseguramos conversión numérica
sqlServer = pd.to_numeric(data['Microsoft SQL Server'], errors='coerce')

# Graficar los datos
plt.figure(figsize=(10, 6))
plt.plot(semanas, mysql, label='MySQL', color='red', marker='o')
plt.plot(semanas, sqlServer, label='Microsoft SQL Server', color='green', marker='o')
...
plt.title('Comparativa de Popularidad: MySQL vs Microsoft SQL Server')
plt.legend()
plt.grid()
